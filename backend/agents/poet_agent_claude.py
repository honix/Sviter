"""
Poet Agent (Claude) - creates poetry pages using Claude Haiku.
"""
from .agent_on_branch import AgentOnBranch


class PoetAgentClaude(AgentOnBranch):
    """
    Poet agent using Claude Haiku that creates three poems.
    """
...
Begin now by calling edit_page for the first poem."""
    ...
    def get_name(cls) -> str:
        return "PoetAgentClaude"

    @classmethod
    def get_branch_prefix(cls) -> str:
        return "agent/poet-claude/"
